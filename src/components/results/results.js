...
import { resultFetchingIniate } from "../../redux/resultAction";
      ...
      for (let l in data) {
        ...
        if (data[l].id === getQues.exam_ques[k].ques_id) {
          if (data[l].weightage === "5") {
            totalhardques++;
            if (
              parseInt(data[l].correctAnswer) ===
              parseInt(getQues.exam_ques[k].selected_op)
            ) {
              totalhardright++;
            }
          }
              ...
              <Col>
                <Card id="card-2">
                  <Card.Body>
                    ...
                    <Card.Text>
                      Total Wrong :{' '}
                      {report.report_no_of_question -
                        report.report_right_question}
                    </Card.Text>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Card id="card-3">
                  <Card.Body>
                    ...
                    <Card.Text id="result-card-text">
                      ...
                      textcolor='#fff'
                        value={(
                          (report.report_total_hardright /
                            report.report_total_hardques) *
                          100
                        ).toFixed(2)}
                      />
                    </Card.Text>
                ...
                <Card id="card-4">
                  <Card.Body>
                    ...
                    <Card.Text id="result-card-text">
                      ...
                      textcolor='#fff'
                        value={(
                          (report.report_total_moderatedright /
                            report.report_total_moderatedques) *
                          100
                        ).toFixed(2)}
                      />
                    </Card.Text>
                ...
                <Card id="card-5">
                  <Card.Body>
                    ...
                    <Card.Text id="result-card-text">
                      ...
                      textcolor='#fff'
                        value={(
                          (report.report_total_mediumright /
                            report.report_total_mediumques) *
                          100
                        ).toFixed(2)}
                      />
                    </Card.Text>
                ...
                <Card id="card-6">
                  <Card.Body>
                    ...
                    <Card.Text id="result-card-text">
                      ...
                      textcolor='#fff'
                        value={(
                          (report.report_total_easyright /
                            report.report_total_easyques) *
                          100
                        ).toFixed(2)}
                      />
                    </Card.Text>
            ...
            <Col id="col-7" xs={6}>
                <div class="result-col">
                  ...
                  <Card.Text id="result-card-text">
                        ...
                        textcolor='#85827f'
                          value={(
                            (report.report_score / report.report_totalmarks) *
                            100
                          ).toFixed(2)}
                        />
                      </Card.Text>
